...
http://localhost:8080/oauth22/oauth/token?username=user1&password=user1&client_id=client1&client_secret=client1&grant_type=password


GET

http://localhost:8080/oauth22/resources/emp/info/123
...
http://localhost:8080/oauth22/logout
Header
-------
Authorization
