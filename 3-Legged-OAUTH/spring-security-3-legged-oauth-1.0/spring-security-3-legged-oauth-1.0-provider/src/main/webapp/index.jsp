...
<html>
	...
	<body>
		...
		<p><a href="https://localhost:8443/api/protected" target="_blank">https://localhost:8443/api/protected</a></p>
		...
		<p><a href="https://localhost:8443/login.jsp">https://localhost:8443/login.jsp</a></p>
		
		<p>If you wish to logout, click the link below.</p>
		<p><a href="https://localhost:8443/logout.do">https://localhost:8443/logout.do</a></p>
